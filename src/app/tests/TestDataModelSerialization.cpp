    ...
    //
    {
        ...
        // Encode every field manually except a.
        {
            err = EncodeStruct(_this->mWriter, TLV::AnonymousTag,
                               MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kBFieldId), t.b),
                               MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kCFieldId), t.c),
                               MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kDFieldId), t.d),
                               MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kEFieldId), t.e));
            NL_TEST_ASSERT(apSuite, err == CHIP_NO_ERROR);
        }
...
void TestDataModelSerialization::TestDataModelSerialization_ExtraField(nlTestSuite * apSuite, void * apContext)
{
    ...
    //
    {
        ...
        {
            err = EncodeStruct(_this->mWriter, TLV::AnonymousTag,
                               MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kAFieldId), t.a),
                               MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kBFieldId), t.b),
                               MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kCFieldId), t.c),
                               MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kDFieldId), t.d),
                               MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kEFieldId), t.e),
                               MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kEFieldId + 1), t.a));
            NL_TEST_ASSERT(apSuite, err == CHIP_NO_ERROR);
        }
...
void TestDataModelSerialization::TestDataModelSerialization_InvalidSimpleFieldTypes(nlTestSuite * apSuite, void * apContext)
{
    ...
    //
    {
        ...
        //
        {
            ...
            {
                err = EncodeStruct(_this->mWriter, TLV::AnonymousTag,
                                   MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kAFieldId), t.b),
                                   MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kBFieldId), t.b),
                                   MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kCFieldId), t.c),
                                   MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kDFieldId), t.d),
                                   MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kEFieldId), t.e));
        ...
        //
        {
            ...
            // Encode every field manually except a.
            {
                err = EncodeStruct(_this->mWriter, TLV::AnonymousTag,
                                   ...
                                   MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kBFieldId), t.b),
                                   MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kCFieldId), t.c),
                                   MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kDFieldId), t.e),
                                   MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::SimpleStruct::kEFieldId), t.e));
                NL_TEST_ASSERT(apSuite, err == CHIP_NO_ERROR);
            }
...
void TestDataModelSerialization::TestDataModelSerialization_InvalidListType(nlTestSuite * apSuite, void * apContext)
{
    ...
    //
    {
        ...
        {
            err = EncodeStruct(_this->mWriter, TLV::AnonymousTag,
                               MakeTagValuePair(TLV::ContextTag(TestCluster::Structs::NestedStructList::kDFieldId), t.e));
            NL_TEST_ASSERT(apSuite, err == CHIP_NO_ERROR);
        }
